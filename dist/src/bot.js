...
var SERVER_URL=process.env.SERVER_URL?process.env.SERVER_URL:_config2.default.get('SERVER_URL');var FACEBOOK_APP_ID=process.env.FACEBOOK_APP_ID?process.env.FACEBOOK_APP_ID:_config2.default.get('FACEBOOK_APP_ID');var FACEBOOK_GRAPH=process.env.FACEBOOK_GRAPH?process.env.FACEBOOK_GRAPH:_config2.default.get('FACEBOOK_GRAPH');var REDIRECT_URI=process.env.REDIRECT_URI?process.env.REDIRECT_URI:_config2.default.get('REDIRECT_URI');var limit=9;var commerces={1329140110447050:{"name":"Speedy","BUSINESS_ID":"com.inoutdelivery.oxxo","PAGE_ACCESS_TOKEN":"EAACmGsSpx0UBAFFMieBuZAUkzuFfLoALZCxNKMZBvxu0yBzrqpEALX4koiwqBtw95SZApwClpz2VA4WJEeMyXVfQP2ws0gfuYWTYRD9ulRIAjV6p6TO45u4g1KPn495D5Itus5ennDIGaM9OVUjBxZAaHdhzIlcgdZC8HpgZCm0IAZDZD"},1242177029183121:{"name":"InOut Bot Demo","BUSINESS_ID":"com.inoutdelivery.inoutdemo","PAGE_ACCESS_TOKEN":"EAAEZCXUHN8RkBACxN9NIi2RpJR8qLQycx7uNKeIlZBZCEjU3gsuugkpfNvIU6OQxiDMIZCpzpXBc6ZAtFQODYJuBsAFIRTilX8IuESrXzNuSTxrhDZA6aMh7tZACD4oh7lGp3K5iMShAX4pptQxqCKgfby55YQCDw0pZCsb5km5sbQZDZD"}};if(!(APP_SECRET&&VALIDATION_TOKEN&&PAGE_ACCESS_TOKEN&&SERVER_URL)){console.error("Missing config values");process.exit(1);}_server.app.use(_bodyParser2.default.json({verify:verifyRequestSignature}));//app.use(parseExpressHttpsRedirect());
