    ...
    (function (global) {
      !function (e) {
        if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module) module.exports = e();else if ("function" == typeof define && define.amd) define([], e);else {
          var f;"undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), (f.qj || (f.qj = {})).js = e();
        }
      }(function () {
              ...
              if (el.length) {
                return function () {
                  ...
                  for (_i = 0, _len = el.length; _i < _len; _i++) {
                    e = el[_i];
                    _results.push(_QJ.addClass(e, className));
                  }
                  return _results;
                }();
              }
            ...
            _QJ.removeClass = function (el, className) {
              ...
              if (el.length) {
                return function () {
                  ...
                  for (_i = 0, _len = el.length; _i < _len; _i++) {
                    e = el[_i];
                    _results.push(_QJ.removeClass(e, className));
                  }
                  return _results;
                }();
              }
            ...
            _QJ.toggleClass = function (el, className, bool) {
              ...
              if (el.length) {
                return function () {
                  ...
                  for (_i = 0, _len = el.length; _i < _len; _i++) {
                    e = el[_i];
                    _results.push(_QJ.toggleClass(e, className, bool));
                  }
                  return _results;
                }();
              }
            ...
            _QJ.append = function (el, toAppend) {
              ...
              if (el.length) {
                return function () {
                  ...
                  for (_i = 0, _len = el.length; _i < _len; _i++) {
                    e = el[_i];
                    _results.push(_QJ.append(e, toAppend));
                  }
                  return _results;
                }();
              }
...
//# sourceMappingURL=jquery.card-compiled.js.map