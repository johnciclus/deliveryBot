import {app, express, Parse} from './server'
...
function getFacebookUserData(facebookId, conversationToken) {
    return rp({
        uri: FACEBOOK_GRAPH + facebookId,
        qs: {access_token: conversationToken, fields: 'first_name,last_name,email,locale,timezone,gender'},
        method: 'GET'
    }).then( body => {
...
module.exports = {app, Parse, rules, payloadRules, buffer, listener, limit, defaultSearch, callSendAPI, sendTypingOn, sendTypingOff, getFacebookUserData, setListener, getListener, deleteListener, setDataBuffer, testAPI};
