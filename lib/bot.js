...
function getFacebookUser(facebookId, conversationToken) {
    return rp({
...
module.exports = {app, Parse, rules, payloadRules, buffer, listener, limit, defaultSearch, callSendAPI, sendTypingOn, sendTypingOff, getFacebookUser, setListener, getListener, deleteListener, setDataBuffer, testAPI};
