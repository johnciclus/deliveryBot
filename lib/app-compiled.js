...
function addProduct(recipientId, productId) {
    ...
    saveCart(recipientId, cart);

    renderAddProductConfirmation(recipientId, productId);
}

function saveCart(recipientId, cart) {
    var consumer = getData(recipientId, 'consumer');
    ...
    consumerCart.save(undefined, {
        success: function success(result) {
            ...
            */
            ...
            console.log('Save consumer kart');
            console.log(result);
        },
        ...
        items.forEach(function (value, key) {
            ...
            product.get(key, {
                success: function success(item) {
                    ...
                    element['quantity'] = items.get(key);
                ...
                error: function error(_error5) {
                    alert("Error: " + _error5.code + " " + _error5.message);
                }
            });
        });
    }
